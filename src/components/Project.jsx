    ...
    return (
        <section id="projects" className="w-full min-h-screen px-8 lg:px-24 py-20 relative">
            ...
            <div className="hidden md:block">
                <CuttingMat className="relative inset-0 max-w-full h-[800px] md:h-[700px] group overflow-hidden">
                    <div className="text-center text-xl md:text-3xl font-bold font-gochi text-amber-100 mt-4 pointer-events-none select-none">
                        My projects board
                    </div>

                    <Draggable className="hidden md:block absolute bottom-[15%] right-[5%] md:bottom-[10%] md:right-[5%] z-20 hover:z-50 cursor-grab active:cursor-grabbing">
                        <div className="w-[240px] h-[160px] md:w-[280px] md:h-[190px] bg-white p-2 -rotate-6 hover:rotate-12 transition-all duration-200 shadow-2xl rounded-lg">
                            <div className="absolute -inset-4 border-4 border-dashed border-[#e35342]/80 rounded-2xl pointer-events-none" />
                            <div className="w-full h-[85%] overflow-hidden rounded">
                                <img src={flow4} alt="Analytics" className="w-full h-full object-contain pointer-events-none" />
                            </div>
                            <p className="text-sm font-bold font-gochi text-[#e35342] text-center uppercase block mt-1">Analytics</p>
                        </div>
                    </Draggable>

                    <Draggable className="absolute bottom-[5%] left-[5%] md:bottom-[10%] md:left-[5%] z-30 hover:z-50 cursor-grab active:cursor-grabbing">
                        <div className="w-[240px] h-[160px] md:w-[280px] md:h-[190px] bg-white p-2 rotate-6 hover:rotate-12 transition-all duration-200 shadow-2xl rounded-lg">
                            <div className="absolute -inset-4 border-4 border-dashed border-amber-100/80 rounded-2xl pointer-events-none" />
                            <div className="w-full h-[85%] overflow-hidden rounded">
                                <img src={flow3} alt="Timeline" className="w-full h-full object-contain pointer-events-none" />
                            </div>
                            <p className="text-sm font-bold font-gochi text-black text-center uppercase block mt-1">Timeline</p>
                        </div>
                    </Draggable>

                    <Draggable className="absolute top-[10%] right-[5%] md:top-[15%] md:right-[8%] z-20 hover:z-50 cursor-grab active:cursor-grabbing">
                        <div className="w-[240px] h-[160px] md:w-[280px] md:h-[190px] bg-white p-2 rotate-3 hover:rotate-6 transition-all duration-200 shadow-2xl rounded-lg">
                            <div className="absolute -inset-4 border-4 border-dashed border-indigo-400/80 rounded-2xl pointer-events-none" />
                            <div className="w-full h-[85%] overflow-hidden rounded">
                                <img src={flow2} alt="Backlog" className="w-full h-full object-contain pointer-events-none" />
                            </div>
                            <p className="text-sm font-bold font-gochi text-indigo-500 text-center uppercase block mt-1">Backlog</p>
                        </div>
                    </Draggable>

                    <Draggable className="absolute top-[5%] left-[5%] md:top-[12%] md:left-[5%] z-10 hover:z-50 cursor-grab active:cursor-grabbing">
                        <div className="w-[240px] h-[160px] md:w-[280px] md:h-[190px] bg-white p-2 -rotate-6 hover:-rotate-12 transition-all duration-200 shadow-2xl rounded-lg">
                            <div className="absolute -inset-4 border-4 border-dashed border-indigo-400/80 rounded-2xl pointer-events-none" />
                            <div className="w-full h-[85%] overflow-hidden rounded">
                                <img src={flow1} alt="Flow Board" className="w-full h-full object-contain pointer-events-none" />
                            </div>
                            <p className="text-sm font-bold font-gochi text-indigo-500 text-center uppercase block mt-1">Flow Board</p>
                        </div>
                    </Draggable>

                    <Draggable className="absolute top-[35%] left-[10%] md:top-[15%] md:left-[35%] z-30 hover:z-50 cursor-grab active:cursor-grabbing">
                        <div className="w-[300px] h-[200px] md:w-[350px] md:h-[200px] bg-white p-3 -rotate-4 hover:rotate-2 transition-all duration-200 shadow-2xl rounded-lg">
                            <div className="absolute -inset-4 border-4 border-dashed border-amber-100/80 rounded-2xl pointer-events-none" />
                            <div className="w-full h-[90%] lg:h-[82%] overflow-hidden rounded-lg">
                                <img src={port1_3} alt="Portfolio V1" className="w-full h-full object-contain rounded pointer-events-none" />
                            </div>
                    ...
                    <Draggable className="absolute top-[60%] left-[20%] md:top-[60%] md:left-[40%] z-10 hover:z-50 cursor-grab active:cursor-grabbing">
                        <div className="w-[300px] h-[200px] md:w-[350px] md:h-[200px] bg-white p-3 -rotate-4 hover:-rotate-6 transition-all duration-200 shadow-2xl rounded-lg">
                            <div className="absolute -inset-4 border-4 border-dashed border-indigo-400/80 rounded-2xl pointer-events-none" />
                            <div className="w-full h-[90%] lg:h-[82%] overflow-hidden rounded-lg">
                                <img src={port1_1} alt="Portfolio V1" className="w-full h-full object-contain rounded pointer-events-none" />
                            </div>
                            <p className="text-xs md:text-base xl:text-xl font-bold font-gochi text-indigo-500 text-center mt-1 lg:mt-2 uppercase block">Portfolio V1</p>
                        </div>
                    </Draggable>
